...
(test-pdf
 [:pdf
  {:title "My Document"
   :author "Me"}
  [:page
   [:text {:font-size 25} "Here are some vector graphics..." 100 80]
   [:polygon {:fill "#FF3300"} [100 150] [100 250] [200 250]]
   [:circle {:fill "#6600FF"} 280 200 50]
   [:style {:scale 0.6}
      [:style {:translate [470 130]}
       [:path
        {:fill ["red" "even-odd"]}
        "M 250,75 L 323,301 131,161 369,161 177,301 z"]]]
   [:text {:font-size 25 :move-down true}
    "And here is some wrapped text..." 100 300]
   [:text {
           :width 412 :align "justify" :indent 30 :columns 2
           :height 300 :ellipsis true
           :font ["Times-Roman" 13]
           }
